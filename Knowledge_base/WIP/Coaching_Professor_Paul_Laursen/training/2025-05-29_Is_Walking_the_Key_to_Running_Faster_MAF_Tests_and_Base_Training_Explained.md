---
title: Is Walking the Key to Running Faster? MAF Tests and Base Training Explained
language: en
category: training
topics:
...
date: '2025-05-29'
summary: The episode delves into MAF (Maximal Aerobic Function) training, emphasizing
  low-intensity workouts to enhance fat oxidation and durability, while also discussing
  the importance of heart rate monitoring and the psychological aspects of training.
key_takeaways:
- MAF = Maximal Aerobic Function , a method using 180 minus your age to find your
  optimal aerobic heart rate.
...
### Key Takeaways:
  ...
  * [Athlete's Compass Episode #53: Base Training for Endurance Athletes](https://athletica.ai/the-athletes-compass-podcast/building-a-strong-foundation-base-training-for-endurance-athletes/)
