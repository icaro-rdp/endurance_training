---
title: 'How To: Fine-Tune Your Max Glycolytic Rate'
language: en
category: physiology
topics:
...
date: '2023-11-11'
summary: This document discusses the physiological mechanisms of glycolysis, including
  lactate kinetics, substrate utilization, and training intensity distribution to
  fine-tune the maximal glycolytic rate for different cycling disciplines.
---
# How To: Fine-Tune Your Max Glycolytic Rate

11 Nov

Written By [Tom Bell](https://www.highnorth.co.uk/articles?author=5e274c1e51e1a6311d478abe)

In this post, we’ll look at how to increase and decrease your maximal glycolytic rate. This is the maximum rate at which you can produce energy by breaking down carbohydrates in a process known as ‘glycolysis’. You may sometimes see the term used interchangeably with the term ‘VLaMax’, which is the maximum rate of lactate production and is closely related to (but not exactly the same as!) the maximal glycolytic rate. 

We’ll present the key training approaches, workout designs and nutritional strategies needed to build a training program that can develop or suppress glycolysis as needed in order to achieve the optimal balance for the specific demands of a particular cycling event or discipline.

Let’s first look at why you might want to increase or decrease your maximal glycolytic rate…

###   
Impact of glycolytic rate on performance

The body has several pathways that can be used to generate energy, and these pathways are always in use concurrently. However, depending on the intensity and duration of exercise, these different energy systems will contribute to greater or lesser extents. 

‘Glycolysis’ is one of the fastest energy pathways and is one of several ‘anaerobic’ processes that do not require oxygen to facilitate the rapid production of ATP, the body’s energy currency. Cyclists who compete in short duration, high intensity events require a high maximal glycolytic rate to enable rapid energy production. This particularly applies to many track cycling disciplines, as well as short time trials like the hill climb competitions popular in the UK from September to November. 

In these competitions, a significant portion of the total energy produced throughout is provided by the glycolytic system, meaning athletes need a high rate of glycolysis (break down of glycogen, the body’s storage form of glucose) to keep up with this high energy demand. 
...
> _In very short-duration cycling disciplines, the fractional utilisation IS NOT the primary determinant of performance (though still important). Therefore in short disciplines, having a high glycolytic rate is usually desirable._

For athletes competing in longer duration disciplines (e.g. road racing, criteriums, MTB XC and Marathon races), fractional utilisation IS one of the key predictors of success. In this case, a lower maximal glycolytic rate is generally more desirable, and training may often focus on reducing the maximal glycolytic rate in order to raise threshold power and fractional utilisation. 

However, it’s worth noting that an excessively low maximal glycolytic rate can still present a limiter in long endurance disciplines if ATP can’t be produced quickly enough in key situations (e.g. to make an important attack, to sprint up a steep climb or to bridge a gap mid-race). Sprinters in particular require a higher maximal glycolytic rate than an all-round road racer and especially a climbing specialist to produce the high power outputs and speed needed to win in fast finishes. Thus, even endurance cyclists may need to understand strategies for improving their glycolytic abilities. 
...
[ training plans to increase max glycolytic rate ](https://www.trainingpeaks.com/my-training-plans/HNP-Anaerobic-Plans)
...
When the the maximal glycolytic rate needs to be reduced, the main training methods that can be used are:
...
One of the best means of training the body to rely less on glycolysis for the production of energy is to restrict its availability to glycogen and force the combustion of fat as the primary fuel source. Performing low intensity rides on a weekly basis in low-carbohydrate availability state is a simple but effective way to tip the aerobic-anaerobic balance favourably. We have a detailed guide on how to perform carbohydrate-restricted training [here](https://www.highnorth.co.uk/articles/how-to-train-with-restricted-carbohydrate-availability). 
...
[ Training plans to reduce max glycolytic rate ](https://www.trainingpeaks.com/my-training-plans/HNP-Endurance-Plans)
...
Finally, here are some final points that may be helpful in the context of fine tuning your maximal glycolytic rate:
  ...
  * Furthermore, the stronger the aerobic capacity, the greater the ability to “mop up” the fatiguing products of glycolysis, meaning that hard efforts with a significant reliance on the glycolytic system can be sustained for longer.
...
[ Previous Previous Critical Power and W’ Explained [inc. CP Calculator] ](https://www.highnorth.co.uk/articles/critical-power-calculator) [ Next Next 5 Ways To Improve Hill Repeat Workouts ](https://www.highnorth.co.uk/articles/hill-repeat-cycling-workouts)
