---
title: "Zone 2 Training & Lactate: Dissecting Iñigo San Millán’s Advice"
language: en
category: NaN
topics: NaN
...
The most detailed discussion into Zone 2 training San-Millán has given is with Peter Attia, spanning [3 whole hours of discussion](https://www.youtube.com/watch?v=-6PDBVRkCKc&t=9312s&ab_channel=PeterAttiaMD). The points below are taken mainly from this interview, together with some others, including a couple of GCN interviews, which can be found [here](https://www.youtube.com/watch?v=dBbK-0vh-d8&ab_channel=GlobalCyclingNetwork) and [here](https://www.youtube.com/watch?v=at3MPoK53dU&t=1080s&ab_channel=GlobalCyclingNetwork). We’ve tried to accurately summarise San Millán’s points and any clarifying details added by us are shown in square brackets.  
...
If you want a more comprehensive discussion of lactate, check out [this article](https://www.highnorth.co.uk/articles/lactate-testing-cycling).   
...
This is also the way that we would define Zone 2 in an ideal world. The top end of Zone 2 is the wattage or heart rate where you _first_ see a notable step-up in blood lactate levels, as illustrated in the figure below at the point marked ‘LT1’. 

Illustration / Chart [https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/596e1b08-b6b4-4f73-8a22-fca2925b2eff/Screenshot+2023-09-22+at+14.27.34.png](https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/596e1b08-b6b4-4f73-8a22-fca2925b2eff/Screenshot+2023-09-22+at+14.27.34.png) 

The midpoint of Zone 2 is broadly where FatMax is achieved (although as shown in [this scientific paper](https://pubmed.ncbi.nlm.nih.gov/24022578/), the actual rate of fat oxidation is very similar at wattages slightly above and below FatMax, so knowing the precise location of FatMax is not all that important). 
...
The reason the talk test works so well, is that there’s a marked ‘ventilatory’ threshold (i.e. change in breathing rate) which corresponds with the increase in blood lactate levels. We write more about the talk test, as well as other methods for determining the top end of Zone 2 [here](https://www.highnorth.co.uk/articles/aerobic-threshold-cycling). 

Using the talk test is also something San Millán recommends in his interviews, and something we strongly endorse too. 

There is also new technology from companies like [Tyme Wear](https://www.tymewear.com), which can measure your ventilation rate in real-time, and determine the top end of your Zone 2 based on your breathing rate. 
...
San Millán lists three key benefits of Zone 2 training:   
  ...
  1. Improving your capacity to oxidise fats (meaning you can burn more grams of fat per minute, and your FatMax occurs at a higher wattage)

  2. Improving ‘mitochondrial function’

  3. Improving lactate transport between muscle fibres
...
San Millán uses [lactate testing](https://www.highnorth.co.uk/articles/blood-lactate-testing-protocols-for-cyclists) heavily in his coaching, and noted several key things: 
...
Lactate meters can be bought for use at home, and the basic testing protocol described by San Millán to assess your lactate levels at a race-relevant workload is a good way to track progress. We write more about lactate testing at home [here](https://www.highnorth.co.uk/articles/blood-lactate-testing-protocols-for-cyclists). 
...
We write extensively about how to use perceptions, in conjunction with objective data in our [Cycling Physiology and Training Science Guide](https://www.highnorth.co.uk/store/p/cycling-physiology-guide). 
...
[ Previous Previous Fatigue Resistance & ‘Durability’ in Cycling: Tests and Training Tips ](https://www.highnorth.co.uk/articles/fatigue-resistance-durability-cycling) [ Next Next Could Carbohydrate ‘Unloading’ Help Improve Cycling Performance? ](https://www.highnorth.co.uk/articles/carbohydrate-unloading)
