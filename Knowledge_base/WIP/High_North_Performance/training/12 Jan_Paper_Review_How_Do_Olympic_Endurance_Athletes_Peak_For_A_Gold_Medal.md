---
title: 'Paper Review: How Do Olympic Endurance Athletes Peak For A Gold Medal?'
language: en
category: training
topics:
...
date: '2023-01-12'
summary: The document comprehensively analyzes the training practices of endurance
  athletes, emphasizing the importance of intensity distribution, microcycle design,
  tapering strategies, and low-intensity training volumes for optimal performance.
---
...
[The Road to Gold: Training and Peaking Characteristics in the Year Prior to a Gold Medal Endurance Performance](https://www.researchgate.net/publication/263010572_The_Road_to_Gold_Training_and_Peaking_Characteristics_in_the_Year_Prior_to_a_Gold_Medal_Endurance_Performance)
...
The athletes recorded the amount of time spent in each of 5 different training intensity zones, where zones 1–2 were below the first lactate threshold (LT1), zone 3 was between LT1 and the second lactate threshold (LT2), and zones 4–5 were above LT2. (For an explanation of these lactate thresholds, see [here](https://www.highnorth.co.uk/articles/lactate-testing-cycling)). 
...
### **Key Findings: Annual Periodisation**
  ...
  1. The athletes trained between 700-900 hours/year. This equates to roughly 13-17H/week on average and supports the widely-held view that volume is one of the major determinants of performance in endurance sports.

  2. The athletes employed a polarised intensity distribution, with 77+/-2% of endurance training sessions being low intensity (Zones 1 and 2), and 23+/-2% of endurance sessions being higher intensity (Zones 3-5). 

  3. 86% of all endurance training time was spent in Zone 1 - a lower intensity than may have been anticipated! We’ll discuss more about this below. 

  4. Training became increasingly more polarised as the year progressed. For example in the general preparation phase, athletes spent an average of 36-mins/week in Zone 3, whereas in the competition phase, they spent just 18-mins/week in this zone. Conversely, weekly Zone 5 time increased from 12-mins/week to 30-mins per week between the general preparation and competition phases respectively. 

  5. Strength training was performed 2-3 times per week during the general and specific preparation phases, but not at all during the competition phase.

  6. The volume of training was highest in the general preparation phase, as illustrated in the chart below. However, interestingly, the volume of sport-specific training was highest in the specific preparation phase. 

Illustration / Chart [https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/ab5d09b9-db03-4bcc-b025-cec74690d4be/Screenshot+2023-01-09+at+18.32.59.png](https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/ab5d09b9-db03-4bcc-b025-cec74690d4be/Screenshot+2023-01-09+at+18.32.59.png) 
...
During the two weeks leading up to the Olympics/World Champs, the athletes did the following:
  ...
  1. Reduced their training volume on average by 4% and 15% during days 14-8 and 7-1 vs the preceding 4 weeks. However, there was large variability. Indeed, 4/11 athletes increased volume during the last 7 days leading up to their main competition! 

  2. Maintained the number of training days per week. In other words, the athletes did not take extra rest days compared to normal. 

  3. Reduced the amount of low-intensity training and increased the frequency of higher intensity sessions (zones 3-5), particularly for Zone 5 sessions. Although the frequency of higher-intensity training was higher, each high-intensity session was typically shorter than in the general preparation phase, meaning the total volume of high-intensity training was not notably different.

  4. Included more frequent bouts of anaerobic sprint training on the skis. 
...
Illustration / Chart [https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/92c05b02-aa90-44ac-941c-3331cbf35b30/Screenshot+2023-01-09+at+18.36.50.png](https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/92c05b02-aa90-44ac-941c-3331cbf35b30/Screenshot+2023-01-09+at+18.36.50.png) 
...
This is a point raised by Inigo San Milan in his interesting [discussion of Zone 2 training](https://www.youtube.com/watch?v=-6PDBVRkCKc&ab_channel=PeterAttiaMD) and his experience coaching Tadej Pogačar. San Milan noted that the lactate flux of well-trained cyclists is very high and that, for the majority of training time, these athletes need to ride at a lower intensity than ‘normal’, based on lactate levels, in order to avoid accumulating too much metabolic strain. 
...
This is a strategy we tend to use with our athletes during periods of intensive racing, in conjunction with so-called ‘block periodisation’ to provide a quick fitness boost between races. You can read more about this strategy in our popular [Physiology Guide](https://www.highnorth.co.uk/store/p/cycling-physiology-guide). 
...
[ Previous Previous Indoor FTP Vs Outdoor FTP: Why They Feel (And Are) Different  ](https://www.highnorth.co.uk/articles/indoor-ftp-vs-outdoor-ftp) [ Next Next Sweet Spot Training In The Winter/Base Phase: Yes Or No? ](https://www.highnorth.co.uk/articles/sweet-spot-training-winter)
