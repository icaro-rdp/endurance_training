---
title: The Norwegian Method of Training in Cycling
language: en
category: training
topics:
- Threshold_intervals
...
date: '2023-11-21'
summary: The Norwegian Method of training focuses on precise intensity control, lactate
  threshold testing, and periodization to optimize performance. It includes a mix
  of low-intensity and high-intensity sessions, with specific training week structures
  and intensity distributions, and uses workload metrics to manage training load and
...
In this article, we’ll cover the following areas: 
  ...
  3. An example training week

  4. Evidence & theory to support the Norwegian Method

  5. Nuances of the Norwegian Method

  6. Example workouts

  7. Is the Norwegian Method suitable for everyone?
...
Illustration / Chart [https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/a16ca480-58f6-4593-8b31-020b5293a323/Screenshot+2023-11-21+at+15.28.20.png](https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/a16ca480-58f6-4593-8b31-020b5293a323/Screenshot+2023-11-21+at+15.28.20.png) 
...
The second threshold (LT2) - sometimes referred to as the ‘maximal lactate steady state’ or ‘MLSS’ - is the highest intensity at which lactate levels remain stable while power is held steady. Above this threshold, lactate levels will rise even when power output is kept constant, and fatigue hits much more rapidly (i.e. within a matter of tens of minutes or less) than it does below this threshold, where efforts can be sustained typically for an hour or more. LT2 is very similar, although not exactly the same, as FTP and critical power. You can read more about LT1 and LT2 and how they can be tested in our [lactate testing guide for cyclists](https://www.highnorth.co.uk/articles/lactate-testing-cycling). 
...
####  _Lactate values are individual and prior testing is needed_
...
We’d recommend doing both a ramp-based lactate profile to determine LT1, and a MLSS protocol to establish LT2. You can do this in a lab, but testing can also be performed at home, following the guidance in [this article](https://www.highnorth.co.uk/articles/blood-lactate-testing-protocols-for-cyclists). 

####  _Training to lactate is not the same as training to power_

Most cyclists will be very familiar with training to power, and the associated [power-based training zones](https://www.highnorth.co.uk/articles/cycling-training-zones). 
...
####  _Target higher and lower lactate levels within the moderate range_
...
####  _Training is periodised_

Importantly, in most cases successful athletes seem to have employed a periodised training approach, where, as competition approaches, some of the moderate lactate sessions are removed in favour of high-lactate sessions, often at race-specific intensities. In other words, the training transitions to follow more of a [polarised intensity distribution](https://www.highnorth.co.uk/articles/polarised-training-cycling) in the 1-2 months leading into important competitions. 

####  _Threshold isn’t strictly at threshold_
...
A key component of the Norwegian Method is very diligent intensity control, using lactate testing. This is something that’s not always feasible for regular non-professional cyclists, whether due to lack of testing equipment, or difficulties with intensity control. Therefore the Norwegian Method might not be appropriate among these athletes, and other training approaches, such as [polarised or pyramidal training](https://www.highnorth.co.uk/articles/polarised-training-cycling) using power as a primary measure of intensity might work better in many cases. 
...
Casado, A., Foster, C., Bakken, M., & Tjelta, L. I. (2023). Does Lactate-Guided Threshold Interval Training within a High-Volume Low-Intensity Approach Represent the “Next Step” in the Evolution of Distance Running Training?.  _International Journal of Environmental Research and Public Health_ ,  _20_(5), 3782.

Eriksson, M. (2020). _Arild Tveiten - coach of Kristian Blummenfelt, Gustav Iden and Casper Stornes on triathlon training the Norwegian way | EP#223_. Scientific Triathlon. [_https://scientifictriathlon.com/tts223/_](https://scientifictriathlon.com/tts223/)
...
Roll R. (2022).  _Gustav Iden & Kristian Blummenfelt: Lessons From The Norwegian Train Reign_ [Video]. YouTube. [ _https://youtu.be/-g0V76jlxFA?si=9cfvckbLIE02qzFj_](https://youtu.be/-g0V76jlxFA?si=9cfvckbLIE02qzFj)

Roll R. (2023). _Human Performance SECRETS Behind Norwegian World Champions: Olav Aleksander Bu_ [Video]. YouTube. https://youtu.be/bdrgVF4gi1E?si=1bHtaoMVre5I_oIq 
...
[ Previous Previous Heat Acclimation for Cyclists: Practical Strategies for Performance Enhancement ](https://www.highnorth.co.uk/articles/heat-acclimation-for-cyclists) [ Next Next Is Zone 2 Training Overhyped Or Under Appreciated? ](https://www.highnorth.co.uk/articles/zone-2-cycling-training-overhyped-coggans-perspective)
