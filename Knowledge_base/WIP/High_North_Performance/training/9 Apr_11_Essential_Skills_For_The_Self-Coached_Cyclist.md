---
title: 11 Essential Skills For The Self-Coached Cyclist
language: en
category: training
topics:
...
date: '2023-04-09'
summary: The document comprehensively covers essential training skills for self-coached
  cyclists, including pacing, endurance base building, tempo and threshold intervals,
  cross-training, cadence drills, and rational planning, emphasizing adaptability,
  discipline, and data-driven training.
---
...
In James Clear’s popular book “[Atomic Habits](https://www.amazon.co.uk/Atomic-Habits-Proven-Build-Break/dp/1847941834/ref=asc_df_1847941834/?hvadid=310973726618&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9046308&hvnetw=g&hvpone=&hvpos=&hvptwo=&hvqmt=&hvrand=13959754158566144112&hvtargid=pla-551566274852&linkCode=df0&psc=1&psc=1&tag=googshopuk-21&th=1)”, he makes reference to how heating an ice cube in a room in tiny increments appears to do nothing initially, before a critical level is reached and suddenly state change happens rapidly!
...
Our [Complete Workout Library](https://www.highnorth.co.uk/store/p/the-complete-workout-library) product is designed just for this purpose and you check that out if you’re at all interested:

[ Illustration / Chart [https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/21e0b9a0-e51a-42c6-823c-931f586ade6f/CWL.png](https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/21e0b9a0-e51a-42c6-823c-931f586ade6f/CWL.png)  Illustration / Chart [https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/21e0b9a0-e51a-42c6-823c-931f586ade6f/CWL.png](https://images.squarespace-cdn.com/content/v1/5e274c204edc972b8161ec64/21e0b9a0-e51a-42c6-823c-931f586ade6f/CWL.png)  ](https://www.highnorth.co.uk/store/p/the-complete-workout-library) [ ](https://www.highnorth.co.uk/store/p/the-complete-workout-library)

[The Complete Workout Library](https://www.highnorth.co.uk/store/p/the-complete-workout-library)

£39.00 

A ready-to-use library of 100+ effective cycling workouts for all major cycling disciplines (MTB, road, CX, gravel etc).

  * Available in power-based, threshold HR-based and Maximum HR-based workout formats.

  * For use with TrainingPeaks (both Basic/Free or Premium) and Intervals.icu.

  * All workouts designed to stimulate strong adaptations in the key components of cycling fitness, including efficiency, threshold power, VO2max, glycolytic capacity etc).

  * All workouts graded for progression level, so that you can easily see how sessions can be developed as your fitness improves.

  * Sessions include references to scientific literature supporting the workout design, where relevant.

  * Comes with bonus user guide, which includes tips on how to get the most from the library, and guidance on selecting appropriate sessions, and how to structure these within a training week.

  * All workouts are exportable to a head unit and indoor training apps like Zwift, TrainerRoad.
...
[Here’s a good post to learn more about time-blocking](https://todoist.com/productivity-methods/time-blocking).
...
In such situations, it’s key to have the discipline to be able to train _in the absence of motivation_. 

  

>  _A helpful idea to keep in mind here is that rather than relying on motivation to stimulate action, see this process as a cycle, where action creates motivation, which fuels further action, and so on._
...
Instead, spend time learning what metrics are the most important for your physiology and the demands of what you’re training for and prioritise these. A post that might be able to help here is one we put together on [the physiological demands of different cycling disciplines](https://www.highnorth.co.uk/articles/cycling-physiological-demands).
...
Programs we use to manage the training of both amateur and professional athletes include TrainingPeaks, WKO5, [Intervals.icu](https://intervals.icu) and [Exphyslab.com](https://www.exphyslab.com), among others.
...
> _The self-coached athlete will need mental strength in situations like pushing hard in their key workouts and managing their nerves before high priority races, but will also call upon this strength to exercise confidence and restraint when recovery and time away from the bike is needed._
...
There are plenty of great resources out there for self-coached athletes to work on building their mental strength, including the posts and books by Josephine Perry of [Performance in Mind](https://performanceinmind.co.uk).
...
[ Previous Previous Cycling Power Profiling Explained ](https://www.highnorth.co.uk/articles/power-profiling-cycling) [ Next Next How To Overcome “Coach’s Block”: 8 Tips For Getting Down To Planning ](https://www.highnorth.co.uk/articles/cycling-coaching-tips)
