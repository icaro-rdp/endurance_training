...
date: '2020-01-27'
summary: The document discusses the impact of rotating weight on cycling performance,
  using physics principles to show that the effect is minimal for most cyclists. It
  emphasizes that other factors like aerodynamics and training are more impactful
  for performance gains.
---
# 5: How Much Does Rotating Weight Matter?
