...
date: '2022-02-15'
summary: 'The lesson explores the principle of Behavioral Reactivity, where measurement
  itself can change an athlete''s behavior, and introduces two psychological models:
  Personality Psychology and Behavior Analysis. It emphasizes the coach''s role in
  shaping behavior through environmental changes rather than changing an athlete''s
  inherent traits.'
---
