...
date: '2025-02-23'
summary: The document discusses the effectiveness of different training intensity
  distributions, including polarized and pyramidal models, and their impact on VO2max
  and time trial performance. It also explores the diagnostic role of NIRS in identifying
  flow limitations in the iliac arteries, a condition affecting cyclists.
---
# 38: Training Intensity Distributions, NIRS, and Iliac Arteries, with Jem Arnold
