...
date: '2024-02-20'
summary: The document discusses the importance of both Functional Threshold Power
  (FTP) and Time to Exhaustion (TTE) in endurance training, emphasizing that they
  are complementary rather than competing metrics. It advocates for a holistic approach
  to training that includes both raising the FTP ceiling and extending TTE duration.
---
