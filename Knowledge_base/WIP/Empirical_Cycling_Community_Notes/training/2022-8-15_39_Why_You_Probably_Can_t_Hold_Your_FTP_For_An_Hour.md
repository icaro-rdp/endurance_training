...
date: '2022-08-15'
summary: The document focuses on threshold training and its adaptations, emphasizing
  the importance of extending time-to-exhaustion (TTE) rather than increasing FTP.
  It discusses extensive threshold work, VO2max training, and the physiological mechanisms
  behind these adaptations, providing practical training principles for endurance
  athletes.
---
# 39: Why You Probably Can't Hold Your FTP For An Hour
