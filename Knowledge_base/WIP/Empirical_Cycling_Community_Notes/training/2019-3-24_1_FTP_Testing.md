...
date: '2019-03-24'
summary: The podcast critiques common FTP testing methods, emphasizing the overestimation
  of true FTP and advocating for longer, more accurate tests. It discusses the physiological
  underpinnings of FTP and provides practical advice for training and tapering based
  on reliable FTP values.
---
# 1: FTP Testing
