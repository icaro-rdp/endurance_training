...
date: '2022-03-05'
summary: The podcast argues that power meters have made lactate testing obsolete by
  directly measuring the maximum sustainable work rate, which lactate testing has
  always attempted to estimate. It emphasizes the importance of threshold intervals,
  VO2max and aerobic HIIT, and the use of power data for training intensity distribution
  and workload modeling.
---
# 36: How Power Meters Make Lactate Testing Nearly Obsolete
