---
title: "How Long Should Your Long Intervals Be to Maximize Threshold Power?"
description: "Three different long intervals. 35 cyclists. 7 weeks of training. The superior workout format yielded a +16% higher threshold power."
date: 2026-08-30
...
<abstract lang="en">
Three different long intervals. 35 cyclists. 7 weeks of training. The superior workout format yielded a +16% higher threshold power.
</abstract>

Nearly all cyclists use long intervals in one form or another.
...
The 4×8 interval yielded nearly twice the performance enhancement compared with 4×4 and 4×16 intervals. [https://www.wattkg.com/wp-content/uploads/2018/03/Long-intervals-development-02.png](https://www.wattkg.com/wp-content/uploads/2018/03/Long-intervals-development-02.png)  The 4×8 interval yielded nearly twice the performance enhancement compared with 4×4 and 4×16 intervals.
...
The 4×16 session too involved _twice_ the duration of the 4×8 session. However, this did not make up for the slightly lower intensity (88% vs 90% of peak heart rate, and 5 vs 10 mmol/L lactate).

It appears then, that for recreationally trained riders with [two weekly interval sessions](<https://www.wattkg.com/cycling-science/>), you need to achieve an intensity slightly higher than threshold training to achieve the biggest performance gains (when comparing session to session).
...
In a previous article I discussed the exciting results concerning the [30/15 high intensity intervals](<https://www.wattkg.com/short-intervals/>). How do they compare to these 4×8 long intervals?
...
_If you want to read more about how to perform the 4×8 interval, I have attached a PDF below. I also added some additional workout progressions of different durations and intensities:_

### Get the 4×8 HIT interval & other workout instructions in my free newsletter

pdf download in newsletter [https://www.wattkg.com/wp-content/uploads/2022/09/4x8-HIT-interval-03-1.png](https://www.wattkg.com/wp-content/uploads/2022/09/4x8-HIT-interval-03-1.png)  pdf download in newsletter
...
PS! You may also experiment with using the above 4×8 sessions with [fast start intervals](<https://www.wattkg.com/fast-start-intervals/>).
...
<nav>
- Source: [Original Article](https://www.wattkg.com/long-intervals/)
