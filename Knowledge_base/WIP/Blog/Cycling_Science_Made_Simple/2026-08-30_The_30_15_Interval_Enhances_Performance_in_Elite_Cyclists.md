---
title: "The 30/15 Interval Enhances Performance in Elite Cyclists"
description: "3 weeks of the 30/15 interval session might improve endurance performance in elite cyclist. Those are the recently published results by Rønnestad et al."
date: 2026-08-30
author: "Cycling Science Made Simple (Wattkg)"
license: "All rights reserved"
---

# The 30/15 Interval Enhances Performance in Elite Cyclists

<abstract lang="en">
3 weeks of the 30/15 interval session might improve endurance performance in elite cyclist. Those are the recently published results by Rønnestad et al.
</abstract>
...
The study reported [increased performance with the 30/15 interval](<https://www.wattkg.com/short-intervals/>) when compared to traditional 4×5 minute intervals.
...
As such, a [recent publication](<https://onlinelibrary.wiley.com/doi/full/10.1111/sms.13627>) from the same lead author sheds more light on the matter (2).

Featured image credit: Duncan Andison/[Shutterstock.com](<https://shutterstock.com>)
...
According to the authors, this places the riders within the category of _elite_ cyclists.
...
This resulted in similar effort during each interval formats as evident by comparable _rate of perceived exertion_(RPE) scores.
...
_Adjusting for heart rate and RPE scores did not change this results. This suggests that the effort invested during testing was comparable between the two groups._
...
_My comment: it should be noted that this intervention period lacks certain elements of traditional tapering, such as significant reductions in time at high intensity (shortened interval duration)._
...
One could also discuss potential upsides of using 30/15 intervals _early_ on in base training.

_If_ this style of short intervals does indeed improve buffering capacity, and the ability to tolerate higher levels of blood lactate…

…would such training allow you to later on perform your traditional long intervals (HIT & threshold) at a _higher_ absolute intensity? And then in turn allow for greater adaptation and further enhanced performance?
...
pdf download in newsletter [https://www.wattkg.com/wp-content/uploads/2022/09/30-15-HIT-interval-02.png](https://www.wattkg.com/wp-content/uploads/2022/09/30-15-HIT-interval-02.png)  pdf download in newsletter
...
_This post is one of many in a series of articles discussing recent research on interval training. You can[get the complete series of articles to your inbox](<https://app.convertkit.com/landing_pages/347085?v=7>) by signing up for my newsletter. Sign-up is free and you can unsubscribe at any time._

_Or, if you want to implement the science-based protocols I write about in your training plan - > check out my [training plan options](</training-plan>)._
...
References:
  ...
  3. Rozenek R et al. Physiological responses to interval training sessions at velocities associated with VO2 max. Journal of Strength and Conditioning Research, 2007;21:188-192
...
<nav>
- Source: [Original Article](https://www.wattkg.com/30-15-interval/)
