---
title: "Power Speed Profile: A test protocol to identify your weapons"
description: "Is the power speed profile the next concept to replace FTP in mapping and tracking cycling performance? We believe it may very well be."
date: 2026-08-30
author: "Cycling Science Made Simple (Wattkg)"
license: "All rights reserved"
---

# Power Speed Profile: A test protocol to identify your weapons

<abstract lang="en">
Is the power speed profile the next concept to replace FTP in mapping and tracking cycling performance? We believe it may very well be.
</abstract>

Is the Power Speed Profile the next tool to replace FTP in mapping and tracking cycling performance?

It may very well be.

If you have ever done bike racing chances are you have experienced the shortcomings of threshold power.

Despite its focus among cyclists, anaerobic threshold or [Functional Threshold Power](<https://www.wattkg.com/trust-ftp-test/>) far from always correlate with the podium at prize giving ceremonies.
...
_(Test protocol follows later in this text)_
...
The main set consists of three sprints separates by easy riding:
  ...
  1. **6 second test** – All-out effort, high resistance, start from standing still
  2. 6 minutes easy riding
  3. **30 second test** – All-out effort, start with 60 RPM, RPM not higher than 140
  4. 15 minutes easy riding
  5. **60 second test** – All-out effort, start with 60 RPM, RPM not higher than 140
...
The main set consists of two all-out efforts separated by a 10 minute recovery period:
  ...
  1. **4 minutes test** – All-out effort. Try to ride with an even pace.
  2. 10 minutes easy riding
  3. **20 minutes test** – All-out effort. Try to ride with an even pace.
...
_Example: If your 1 minute power recording was 8.0 W/kg and the top cyclist benchmark is 10.5 W/kg your performance index will be:_

_Performance index: 8.0 / 10.5 x 100 = 76.2_

Basically, the top rider benchmark for each critical period will always be 100. 

The performance index of an allrounder. The PI is evenly distributed across all critical periods. Photo credit: Van Bon & Vroemen – Sportgericht 2018 [https://www.wattkg.com/wp-content/uploads/2020/05/Power-speed-profile-allrounder.png](https://www.wattkg.com/wp-content/uploads/2020/05/Power-speed-profile-allrounder.png)  _The performance index of an allrounder. The PI is evenly distributed across all critical periods. Photo credit: Van Bon & Vroemen – Sportgericht 2018_ The performance index of asprinter. The PI is skewed towards performance for 5 and 15 second durations. Photo credit: Van Bon & Vroemen – Sportgericht 2018 [https://www.wattkg.com/wp-content/uploads/2020/05/Power-speed-profile-sprinter.png](https://www.wattkg.com/wp-content/uploads/2020/05/Power-speed-profile-sprinter.png)  _The performance index of asprinter. The PI is skewed towards performance for 5 and 15 second durations. Photo credit: Van Bon & Vroemen – Sportgericht 2018_
...
**1 |** Download the [test protocols](<http://powerspeedprofile.com/protocol>) for either Garmin or Zwift. Or enter the test protocols into your computer/trainer system manually.

**2 |** Perform test protocol 1 and 2 with at least one day of recovery between.

**3 |** Enter your results into the calculator at [powerspeedprofile.com](<http://powerspeedprofile.com/>) to produce your profile and performance index.

**4 |** Re-test your results every 2-4 months to track your progress and evaluate the effect of your training

_Big shout out to photographer[Jimmy Hansen](<https://www.jimmyhansen.com/>) for providing me with a banger of a featured photo. IG: [@mrjimmyhansen](<https://www.instagram.com/mrjimmyhansen/>)_
...
References:
  ...
  6. UCI/WCC Power Profile Test (n.d.). Retrieved from: https://cdn.wattbike.com/uploads/uk/docs/UCI-power-profile-test.pdf
  7. Tanner R & Gore C (2012). Physiological tests for elite athletes (2nd edition). Human Kinetics.

<nav>
- Source: [Original Article](https://www.wattkg.com/power-speed-profile/)
