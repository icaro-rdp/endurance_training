---
title: Do Short Intervals Produce Greater Threshold Power?
language: en
category: training
topics:
- Threshold_intervals
...
date: '2026-08-30'
summary: The study compares the effects of short (30/15) and long (4x5) interval training
  on competitive cyclists, showing that short intervals improve performance across
  various power outputs and VO2 max. This research highlights the importance of interval
  format in training adaptation and suggests varying training stimuli to enhance endurance
  capacity.
---
# Do Short Intervals Produce Greater Threshold Power?

Both long and short intervals are common elements of most [cycling training plans](https://www.wattkg.com/cycling-science/).
...
In this setting, the 30/15 short interval format outperformed the 4×5 session across all performance parameters. [https://www.wattkg.com/wp-content/uploads/2020/02/short-intervals-performance.png](https://www.wattkg.com/wp-content/uploads/2020/02/short-intervals-performance.png)  In this setting, the 30/15 short interval format outperformed the 4×5 session across all performance parameters.
...
EDIT: A more recent publication by the same lead author has demonstrated the [effects of the 30/15 interval on elite riders](https://www.wattkg.com/30-15-interval/).
...
PS! You may also experiment with using the above 30/15 sessions with a [fast start interval style](https://www.wattkg.com/fast-start-intervals/).
...
It could be hypothesised that  _if_ these riders were already accustomed to a 4×5-like interval format, they would be less likely to achieve progress with the same format, as compared to varying their training stimuli with a new interval format, such as 30/15.

If, and to what extent this mechanism has impacted the results, I cannot say.

The above represents examples of why we always put  _most_ faith in research findings when _multiple studies_ reproduce consistent results. As for the 30/15 interval, we still have to wait for these results to be reproduced in the cycling population.
...
_This post the first of many in a series of articles discussing recent research on interval training. You can[get the complete series of articles to your inbox](https://app.convertkit.com/landing_pages/347085?v=7) by signing up for my newsletter. Sign-up is free and you can unsubscribe at any time._
