---
title: Higher Oxygen Consumption (VO2) With Decreasing High Intensity Intervals
language: en
category: training
topics:
...
date: '2026-08-30'
summary: The study demonstrates that decreasing high intensity intervals can increase
  time above 90% of VO2 max, which is beneficial for improving maximal aerobic capacity.
  This format can be an effective alternative to traditional interval training.
---
# Higher Oxygen Consumption (VO2) With Decreasing High Intensity Intervals
...
[Maximal oxygen consumptio](https://www.wattkg.com/vo2-max/)[n](https://www.wattkg.com/vo2-max/) (VO2 max) is a common measure of aerobic capacity. And while bike races are not necessarily won by the rider with the highest VO2 max, it is useful to be in the ballpark.
...
Of the many training intensities that may drive development of your VO2 max, high intensity intervals are a popular choice. And to that end, _decreasing high intensity intervals_ may be an interesting choice.
...
Vaccari and colleagues published the results from a study on decreasing high intensity intervals in the _European Journal of Applied Physiology_ back in 2020 (1).
...
Twelve amateur cyclists aged 29-62 years (mean age 41) partook in the experiment. They all reported _at least_ 3 training sessions per week in the previous 6 months.
...
Interestingly, both the decreasing and long intervals resulted in the cyclists reaching 90% of their VO2 max quicker than did the short intervals. However, a notable difference was that decreasing intervals allowed riders to more effectively _remain_ above 90% of VO2 max. Whereas during the long intervals, riders would more often fall below the 90% mark (during the recovery periods and initially during next effort).
...
_Very briefly explained, PCr is involved in making energy (ATP) available to working muscles. During muscular work, PCR is reduced. The authors argue that the faster the depletion of PCr, the higher the oxygen consumption (VO2)._
...
### Get your decreasing interval workout instructions

PDF download in newsletter [https://www.wattkg.com/wp-content/uploads/2023/09/Decreasing-intervals-01-213x300.png](https://www.wattkg.com/wp-content/uploads/2023/09/Decreasing-intervals-01-213x300.png)  PDF download in newsletter

_When you subscribe to my newsletter you will receive the decreasing intervals and other**workout instructions** , **science reviews** and discussions of**best training practices**. There is also occasional information about my paid services. I will take care not to clutter your inbox._

## Caveats

As always, you should soberly consider potential limitations of a study.

For starters, this study was performed on _trained_ subjects only. So probably not the strongest weekend warriors, and definitely not pros. So we cannot conclude if the results would look different in a more highly trained group.
...
This study adds to the research I have previously discussed on [fast-start intervals](https://www.wattkg.com/fast-start-intervals/) and short intervals. Collectively, these studies adds to your knowledge of how you can manipulate duration, intensity and recovery periods in search of your desired training stimulus.
...
References:
  ...
  1. Vaccari F et al. High-intensity decreasing interval training (HIDIT) increases time above 90% of VO2 peak. European Journal of Applied Physiology, 2020;120:2297-2405
  2. Bell PG et al. The physiological profile of a multiple Tour de France winning cyclist. Medicine & Science in Sports & Exercise, 2017;49(1):115-123
  3. Vaccari F et al. High-intensity interval training: optimizing oxygen consumption and time to exhaustion taking advantage of the exponential reconstitution behaviour of D’. European Journal of Applied Physiology, 2023;123:201-209
