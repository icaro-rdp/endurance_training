...
author: Jem Arnold
date: '2021-10-19'
summary: The document explores the use of paraspinal muscle oxygenation to predict
  cycling time to exhaustion, highlighting its relationship with lactate kinetics,
  mitochondrial and cellular adaptation, VO2max, cardiovascular and hemodynamic responses,
  substrate utilization, and thresholds. It also discusses the limitations of vastus
  lateralis muscle oxygenation and the role of autonomic and cardiac monitoring in
  predicting TTE.
---
