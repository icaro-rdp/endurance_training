---
title: Comparing Metabolic Response to Hard-Start VO2max Intervals
language: en
category: training
topics:
...
author: Jem Arnold
date: '2019-02-06'
summary: The document emphasizes the importance of hard-start VO2max intervals for
  stimulating aerobic metabolism and maintaining high VO2 levels. It also discusses
  cardiovascular responses, metabolic thresholds, and cellular adaptations, highlighting
  the variability in individual responses and the role of accurate breathing technique
  in maintaining reliable VO2 measurements.
---
...
The principle of the hard-start VO2max interval is to set off at a very high intensity in order to rapidly reach near VO2max (for which 90% HRmax [is a good target for most people](https://sparecycles.blog/2018/06/26/update-to-prescribing-vo2max/)). Power can then be slowly decreased so that HR (and VO2) remain near-maximal, but the workload can be sustained for 5+ minutes without blowing up.

> **More specific directions:**
> 
>   * Set off at extreme-intensity, ie. at a **power above your VO2max workload** (>PVO2max). This should feel _near-maximal_ effort.
>   * This should **elicit 90% VO2max within ~90 seconds** for most people.
>   * **90% HRmax** can be used as a target for most people, but HR is not a great corollary to real measured VO2.
...
> 
> **Total haemoglobin (tHb)** and **Muscle Oxygen Saturation (SmO2)** reported by the Moxy monitors tell us the total blood oxygen carrying capacity or blood volume (tHb) within the local tissue and the percent saturation of that capacity (SmO2 in %). The absolute and relative values begin to build a picture of local muscle aerobic capacity, ie. how well the muscle can extract and utilize the available O2 to produce power.
> 
...
> [ 3x6min Hard-Start VO2max – Muscle oxygenation (Moxy) & VO2 Master Pro data [https://sparecycles.blog/wp-content/uploads/2019/01/combined_01_li-5-1.jpg?w=1100](https://sparecycles.blog/wp-content/uploads/2019/01/combined_01_li-5-1.jpg?w=1100)  ](https://sparecycles.blog/wp-content/uploads/2019/01/combined_01_li-5-1.jpg)3x6min Hard-Start VO2max – Muscle oxygenation (Moxy) & VO2 Master Pro data
> 
> Top chart shows:
> 
...
>   * Note: unfortunately the VO2mask ran out of batteries before the third interval!  Illustration / Chart [https://ssl.gstatic.com/chat/emoji/8plxssjuw1/emoji_u2639.png](https://ssl.gstatic.com/chat/emoji/8plxssjuw1/emoji_u2639.png) 
...
> [ 3x6min Hard-Start VO2max – Visualizing trends [https://sparecycles.blog/wp-content/uploads/2019/01/combined_01_li-3.jpg?w=1100](https://sparecycles.blog/wp-content/uploads/2019/01/combined_01_li-3.jpg?w=1100)  ](https://sparecycles.blog/wp-content/uploads/2019/01/combined_01_li-3.jpg)3x6min Hard-Start VO2max – Visualizing trends
> 
...
> ### Summary
> 
>   * This workout was able to demonstrate the difference between a **hard-start** and a… **_hedged-_ start** strategy in stimulating the aerobic system up to maximal, and accumulating time at our target metabolic states of >90% HRmax, >90% VO2max, or minimum %SmO2.
>   * **Hard-starts must be _hard_** , with intensity well above what could be sustained for the entire interval duration in order to maximize metabolic training stress of the interval.
>   * We also demonstrated that for this athlete, **90% HRmax seemed to slightly _over_ -predict 90% VO2max**. As in at 90% HRmax, the athlete was slightly under 90% VO2max. They were able to sustain >90% HRmax for over 5min during the second interval while hovering _just about_ at 90% VO2max, but strictly speaking only accumulated 2.5min at or above that target.
> 
...
The athlete above showed the typical hard-start VO2max interval, where after the first 90 seconds the interval workload more or less stabilized at a steady power output. But of course I have to share what my own intervals look like when [blood flow restriction begins to affect my Left leg.](https://sparecycles.blog/2018/07/24/left-leg-burns/)

Spoiler: systemic metabolism remains elevated, but power output decreases dramatically.

> [ 3x6min Hard-Start VO2max – Muscle oxygenation (Moxy) & VO2 Master Pro data [https://sparecycles.blog/wp-content/uploads/2019/01/combined_02_li-2.jpg?w=1100](https://sparecycles.blog/wp-content/uploads/2019/01/combined_02_li-2.jpg?w=1100)  ](https://sparecycles.blog/wp-content/uploads/2019/01/combined_02_li-2.jpg)3x6min Hard-Start VO2max – Muscle oxygenation (Moxy) & VO2 Master Pro data
> 
> Top chart shows:
> 
...
No  _hedged_ -start for me! I have experience with exactly what intensity works for me, so I jump straight into a very hard-start. Again the first 90sec is crucial, and I am able to get **HR up _nearly_ to 90% HRmax**. More importantly, **VO2 reaches 90% VO2max and remains elevated** for the entire remaining interval duration. Looking at muscle oxygenation, **SmO2** still shows a more **gradual decline** through the first interval.

All three 6min intervals are very consistent in time accumulated above 90% HRmax and 90% VO2max, and for SmO2 de-saturation. One interesting comparison to the other athlete above, is that for me **90% HRmax seemed to slightly _under-_ predict 90% VO2max**. Total time accumulated >90% HRmax was 11:29, compared to 14:44 above >90% VO2max.

However, instead of power stabilizing after 90sec, **my Left leg** (pink power line in the bottom chart) **continues to decline** as [blood flow and oxygen delivery becomes restricted](https://sparecycles.blog/2019/01/15/vo2master-moxy-revealing-metabolic-limitation-part-1/). Meanwhile my Right leg (blue) takes over and maintains a more stable workload. The net result is that overall **power output** (yellow line) **decreases steadily** through the entire interval. My power output through the hard-start interval declines by over 25%, compared to the athlete above who stabilized with only a 15% decline.

### 

> ### Summary
> 
>   * **Hard-starts must be _hard!_** Attaining anything near VO2max requires a near-maximal effort. Worth repeating.
>   * Two similar workouts by two different athletes show the difference in metabolic response, especially in how well HR correlates to VO2. I would still suggest **90% HRmax can be used to estimate 90% VO2max** , but your individual response will vary.
...
>   * I wonder how long these VO2max intervals could be maintained before either exhaustion, or VO2 cannot be sustained above 90%? [Billat et al, 2013](https://www.ncbi.nlm.nih.gov/pubmed/22752344/) found subjects were able to spend ** _over 20 minutes_ continuously above 90%VO2max**! So there may be room to push these 6min intervals further.
...
Check out the comparison between these continuous VO2max intervals and 30/15s intermittent microbursts [in the next post](https://sparecycles.blog/2019/03/13/comparing-30-15-vo2max-intervals/).
