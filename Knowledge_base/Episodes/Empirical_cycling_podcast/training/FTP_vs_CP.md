...
date: '2025-01-01'
summary: The document discusses the differences between FTP and Critical Power, their
  derivation, and their appropriate uses in training and performance analysis. It
  emphasizes the importance of using each model within its valid domain to avoid systematic
  over-prescription of training intensity.
---
  |'
---
