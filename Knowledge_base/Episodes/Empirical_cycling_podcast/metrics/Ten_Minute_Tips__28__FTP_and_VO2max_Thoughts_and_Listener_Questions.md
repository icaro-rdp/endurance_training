...
VO2max (Ceiling: Cardiac Output / Stroke Volume)
  │
  ├── Fractional Utilization (75–85% of VO2max)
  │     └── Functional Threshold Power (FTP / Steady State MLSS)
  │           └── Time-to-Exhaustion (TTE: 35–70+ minutes)
...
Is TTE at FTP >= 50-60 min? ──NO──> Focus on Threshold / Sweet Spot TTE Extension
         │ YES
Is Base Volume Established? ──NO──> Build Zone 2 Aerobic Base Volume
         │ YES
Is Race > 4-6 Weeks Away?   ──NO──> Use Race-Prep Sharpening / Mixed Microcycles
         │ YES
