---
title: "How To Put a Rear Wheel on a Bike"
language: en
category: training
topics:
  - Aerobic_base
  ...
  - TTA_TTE
  - LT1_VT1
source: "https://selleanatomica.com"
...
Coach Darryl actually witnessed that exact scenario on a ride. A [rider in front of him](https://selleanatomica.com/blogs/homepage-blog/bike-shorts-don-t-let-the-rider-behind-you-take-you-down) clipped the rear wheel of another rider from the side, and her spokes caught the other rider’s CAM lever and opened it. Darryl watched in horror as the rear wheel of the bicycle came off and sent both riders tumbling to the ground.
...
This is probably the most common issue you’ll face as a cyclist, and it occurs regardless of what type of axle you have. When you have to change a tube and [insert a tire boot](https://selleanatomica.com/blogs/homepage-blog/what-is-a-tire-boot) on a [flat tire](https://selleanatomica.com/blogs/homepage-blog/what-to-do-about-fixing-a-flat-bike-tire-while-out-on-a-ride), you’ll need to take the wheel off the bike. That’s when you’ll definitely need to know how to remove the rear bicycle wheel and put it back on. 

### You Have a Broken Spoke

A [broken spoke](https://selleanatomica.com/blogs/homepage-blog/what-to-do-when-you-break-a-bike-spoke) isn't usually enough reason to remove your wheel in the middle of the ride. In most cases, you can get home safely and then take your bike to mechanic to have the spoke repaired. 
...
Getting the wheel off is easier than bicycle rear wheel assembly, but this process still requires the right approach: 
  ...
  1. Shift the [chain](https://selleanatomica.com/blogs/homepage-blog/how-to-prevent-your-bike-chain-from-coming-off) to the farthest gear from the bike.
  ...
  3. Standing over the bike, place one hand on the rear wheel and one on the [saddle](https://selleanatomica.com/collections/saddles-1).
  4. Hold the wheel in place on the ground and lift the bike up. This will open the derailleur and allow the [c](https://selleanatomica.com/blogs/homepage-blog/how-to-prevent-your-bike-chain-from-coming-off)[hain to disengage](https://selleanatomica.com/blogs/homepage-blog/how-to-prevent-your-bike-chain-from-coming-off) from the bike.
...
## FAQs About Rear Bike Wheel Installation

#### How do you remove a rear bicycle wheel?

Shift into the smallest cog on your cassette, then loosen the skewer or thru-axle. Standing over the bike, hold the wheel steady on the ground and lift the frame upward. This opens the derailleur so the chain disengages and the wheel drops free.

####   
What gear should the bike be in to remove the rear wheel?

Always shift into the smallest cog, farthest from the bike frame. This creates the most slack in the chain and makes it much easier to get the wheel off and back on without fighting the derailleur.

####   
How do you put rear wheel on bike with disc brakes and a thru-axle?

Start by lining the chain on the smallest cog, then pull the derailleur back to create room as you lower the frame onto the wheel. Guide the brake rotor carefully between the brake pads so it slides into the caliper without rubbing. Once the rotor is seated, insert the thru-axle through the frame and hub, then tighten it securely. Before riding, spin the wheel to make sure it turns freely and that the rotor isn’t scraping against the pads—if it does, loosen the axle slightly, realign, and retighten.

_Like these cycling tips from Coach Darryl? Check our blog and subscribe to our newsletter to get fresh insights each week!___

_Look for more from Coach Darryl over at his_[ _website_](https://www.coach-darryl.com/) _._

_Image by[Alexas_Fotos](https://pixabay.com/users/alexas_fotos-686414/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2293961) from Pixabay  
_
