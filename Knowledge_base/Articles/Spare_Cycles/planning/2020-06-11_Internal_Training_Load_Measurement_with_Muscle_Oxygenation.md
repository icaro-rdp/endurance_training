---
title: "Internal Training Load Measurement with Muscle Oxygenation"
language: en
category: planning
topics:
...
[ Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_09-57-47.jpg](https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_09-57-47.jpg)  ](https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_09-57-47.jpg)  
  
So I thought an easier place to start would be first laying out some questions and smaller ideas, instead of trying to perfect a _grand unified theory of exercise physiology_ , and end up not writing anything at all..

* * *

## Muscle Oxygenation vs Heart Rate for Internal Training Load Monitoring

A recent small, but compelling finding in our research with [Moxy muscle oxygenation](https://www.moxymonitor.com/) was looking at the reliability & repeatability of muscle oxygen saturation (SmO2) compared to HR for a typical high intensity interval workout.

We had a group of well-trained male subjects (VO2max > 60 ml/kg/min) perform a series of 4x4min high intensity workouts with multiple Moxy sensors. One of the ways we looked at the SmO2 data was to calculate a ‘deoxygenation area’ for each interval. Where the difference between peak SmO2 and measured SmO2 during each interval were summed to arrive at a total deoxygenation area for the workout. This ends up looking like an ‘area _above_ the curve’, as illustrated below.
...
The process using SmO2 gives us something like a **measure of total _internal_ workload** at the muscle under investigation (arb units: SmO2*sec). We compared this metric to **time above 90% HRmax** as a measurement of total internal training load.

Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2020/06/wko5_2020-06-10_10-57-20-1.jpg](https://sparecycles.blog/wp-content/uploads/2020/06/wko5_2020-06-10_10-57-20-1.jpg)    
...
I’ve [argued in the past](https://sparecycles.blog/2017/12/13/prescribing-vo2max/) that time >90% HRmax is a decent, but [far from perfect](https://sparecycles.blog/2018/06/26/update-to-prescribing-vo2max/) proxy for time >90% VO2max. However my opinion has gradually been drifting away from accepting this relationship as a useful comparison.
...
Power is exclusively a measurement of external work and doesn’t tell us _how_ the body is producing that power. There are many helpful models that can estimate _internal intensity_ from _external workload_ (a distinction for another time), but [I’ve written previously](https://sparecycles.blog/2019/07/17/vo2-measured-to-modeled/) about some issues I have with over-extrapolating metabolic information from power.  
...
> The interesting numbers to look at here are the [coefficients of variation](https://en.wikipedia.org/wiki/Coefficient_of_variation) (CV). This tells us how much each measurement varies between workouts, as a percent of   
> the mean value (top row). 
> 
> [ chrome_2020-06-10_11-05-53_inked [https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_11-05-53_inked.jpg](https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_11-05-53_inked.jpg)  ](https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_11-05-53_inked.jpg)
> 
...
> 
> [ chrome_2020-06-10_11-11-29_inked [https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_11-11-29_inked.jpg](https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_11-11-29_inked.jpg)  ](https://sparecycles.blog/wp-content/uploads/2020/06/chrome_2020-06-10_11-11-29_inked.jpg)
> 
...
EDIT: A good question posted below got me to look at how power, RPE, HR, and oxygenation area were related. [More detail below](https://sparecycles.blog/2020/06/11/internal-training-load-measurement-with-muscle-oxygenation/#comment-3456), but briefly:
...
This is another promising application for using Moxy and other portable NIRS sensors for tracking internal training load. I’ve encountered some [other papers](https://pubmed.ncbi.nlm.nih.gov/32429406/) looking at similar ‘area under the curve’ calculations for NIRS measurements, sometimes with [mixed results](https://pubmed.ncbi.nlm.nih.gov/28937254/). And similar findings for reliability of NIRS over HR. Such as in trail running where NIRS measurements were found to give a better indication of running intensity than HR across varied terrain ([Born et al, 2017](https://pubmed.ncbi.nlm.nih.gov/27396389/)). I would imagine this finding would translate well to cycling races where intensity is even more highly variable.

This work-oxygenation factor gives us a potential tool for comparing **how much external work has been performed for a given level of local deoxygenation**. Importantly this can be calculated at various workloads and over various durations, starting to build a more detailed **power-duration-_oxygenation_ profile** for an individual athlete.
...
I think this metric will be most useful in tracking changes within an individual athlete over time, rather than comparing efficiency between individuals. Looking at how this value may change over time with training might reveal something more about **_how_ physiology has responded to that training.**

Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2020/06/wko5_2020-06-10_19-57-15.jpg](https://sparecycles.blog/wp-content/uploads/2020/06/wko5_2020-06-10_19-57-15.jpg)    
...
That’s a topic that raises _many_ questions. Which I will hopefully write about soon(ish).
