---
title: "Speculating on Physiology in the Lab vs on the Road"
language: en
category: training
topics:
  - Lab_vs_field
...
What started as Part 3 of my recent [series](https://sparecycles.blog/2019/11/27/comparing-vo2-master-to-trueone-part-1/) of [articles](https://sparecycles.blog/2019/12/04/comparing-vo2-master-to-trueone-part-2/) comparing the VO2 Master Pro to the TrueOne 2400 metabolic cart, half way through spontaneously turned into a more interesting comparison of the same workout performed outside on the road, and in the lab on the trainer. So let’s go with that!
...
## 4x4min Severe Intensity Intervals
...
For the LAB trial I alternated between the **VO2 Master Pro** O2 analyzer and the **TrueOne 2400** metabolic cart to give them a direct side-by-side comparison within the same workout. This trial was performed [with the same set-up as detailed previously](http://comparing-vo2-master-to-trueone-part-1/#Ramp-Incremental-Tests).

Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/screenshot_20191226-081601.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/screenshot_20191226-081601.jpg) 
...
Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/fieldimage-e1610045953473.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/fieldimage-e1610045953473.jpg)    
...
Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/powerhrcad_comparison3.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/powerhrcad_comparison3.jpg) 
...
This is the first interesting finding comparing lab to field, trainer to road. The literature reports that athletes tend to adopt a lower preferred cadence in the field ([Hansen et al, 2002](https://www.researchgate.net/publication/11572914_Crank_inertial_load_affects_freely_chosen_pedal_rate_during_cycling), [Bertucci et al, 2012](https://www.researchgate.net/publication/235370557_Gross_Efficiency_and_Cycling_Economy_Are_Higher_in_the_Field_as_Compared_with_on_an_Axiom_Stationary_Ergometer), [Nimmerichter et al, 2015](https://www.researchgate.net/publication/271221528_Gross_Efficiency_During_Flat_and_Uphill_Cycling_in_Field_Conditions)). All else being equal a lower cadence will tend to be more metabolically efficient at the same power ([Leirdal & Ettema, 2011](https://www.researchgate.net/publication/50851938_The_relationship_between_cadence_pedalling_technique_and_gross_eYciency_in_cycling)). This is one of the possible contributing factors to the common perception that higher power is easier to achieve on the road than on the trainer. Although this rabbit hole gets waaaay more complicated, as we’ll begin to find out.

Most of the studies I’ve encountered that look at cadence find significant differences in **[Gross Efficiency (GE)](https://sparecycles.blog/2019/07/24/power-from-vo2-and-vo2-from-power/)** between a wider spread of cadences, eg. 60 vs 120 rpm ([Tomabechi et al, 2018](https://www.researchgate.net/publication/328034781_Effects_of_3-Week_Work-Matched_High-Intensity_Intermittent_Cycling_Training_with_Different_Cadences_on_VO2max_in_University_Athletes)). I’m not sure whether a 10 rpm difference in my case would have significantly changed GE, but that’s only one factor at play. Certainly subjectively I found it easier to maintain a higher power at a lower cadence in the field than subsequently on the trainer.

* * *

## VO2, Blood Lactate, RPE

Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/vo2bla_comparison2.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/vo2bla_comparison2.jpg) 
...
My current understanding is that cycling on a stationary trainer can feel harder in part because there is a greater concentration of muscle force production from the quads. Whereas on the road there is a wider contribution of force output from the quads **and glutes especially** (we’ll come back to this), as well as a ton of other accessory & stabilizer muscles. So maybe the effort feels more _distributed_?

But this is seriously tip of the iceberg..   
References for above hypothesis (expect another article 😅) 

  * [Hansen et al, 2002](https://www.researchgate.net/publication/11572914_Crank_inertial_load_affects_freely_chosen_pedal_rate_during_cycling)
  * [Bertucci et al, 2007](https://www.researchgate.net/publication/6234744_Laboratory_versus_Outdoor_Cycling_Conditions_Differences_in_Pedaling_Biomechanics)
  * [Bertucci et al, 2012](https://www.researchgate.net/publication/235370557_Gross_Efficiency_and_Cycling_Economy_Are_Higher_in_the_Field_as_Compared_with_on_an_Axiom_Stationary_Ergometer)
  * [Arkesteijn et al, 2013](https://www.researchgate.net/publication/233770194_The_Effect_of_Turbo_Trainer_Cycling_on_Pedalling_Technique_and_Cycling_Efficiency)
  * [Nimmerichter et al, 2015](https://www.researchgate.net/publication/271221528_Gross_Efficiency_During_Flat_and_Uphill_Cycling_in_Field_Conditions)
  * [Aasvold et al, 2019](https://www.researchgate.net/publication/331289190_Joint_specific_power_production_in_cycling_The_effect_of_cadence_and_intensity)
...
Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/verfvt_comparison4.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/verfvt_comparison4.jpg) 
...
Considering the slightly higher power in the FIELD and _very_ different conditions compared to the LAB, ventilation remained similar between trials. A trend toward slightly **lower breathing rate (Rf)** and slightly **higher breathing depth (Vt) on the trainer** produced mostly similar ventilation (VE).

I wrote about an experiment a while ago [comparing road to trainer for a longer steady-state interval](https://sparecycles.blog/2019/08/21/metabolic-steady-state-inside-vs-outside/). For those 30min steady-state intervals I also saw **lower Rf and higher Vt on the trainer** , as well as an upward drift in Rf and VE during the constant power interval. VO2 during both trials was virtually the same.
...
> [ View this post on Instagram ](https://www.instagram.com/p/B6irHeNlpD5/?utm_source=ig_embed&utm_campaign=loading)
> 
> [A post shared by Jem Arnold (@jem_arnold)](https://www.instagram.com/p/B6irHeNlpD5/?utm_source=ig_embed&utm_campaign=loading)

Let’s backtrack for a moment to core stability on the bike. Once again, the literature seems to point to **greater activation of quads when the bike is fixed to a stationary trainer**. Furthermore it is suggested that the core can “turn off” since active stabilization to keep the bike upright is unnecessary on the trainer ([Arkesteijn et al, 2013](https://www.researchgate.net/publication/233770194_The_Effect_of_Turbo_Trainer_Cycling_on_Pedalling_Technique_and_Cycling_Efficiency)). 
...
To keep speculating, if the core isn’t sufficiently stabilizing the pelvis on a fixed trainer, I wonder if the glutes, as the major prime movers of the hips, won’t have a stable base of support to push off to generate force? Is that contributing to the reported lower muscle activity ([Arkesteijn et al, 2013](https://www.researchgate.net/publication/233770194_The_Effect_of_Turbo_Trainer_Cycling_on_Pedalling_Technique_and_Cycling_Efficiency), [Aasvold et al, 2019](https://www.researchgate.net/publication/331289190_Joint_specific_power_production_in_cycling_The_effect_of_cadence_and_intensity)) and observed lower metabolic activity (see SmO2 below) of the glutes and higher recruitment of quads on the trainer?
...
Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/smo2_comparison2.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/smo2_comparison2.jpg) 

  * Muscle Oxygen Saturation (SmO2) measured at the quads (vastus lateralis, VL), glute max, and deltoid (shoulder).
  * The **VL are almost always the most metabolically active and generate the most force** on the pedal downstroke ([Bhambhani, 2012](https://www.researchgate.net/publication/258666287_Review_Application_of_near_infrared_pectroscopy_in_evaluating_cerebral_and_muscle_haemodynamics_during_exercise_and_sport), [Aasvold et al, 2019](https://www.researchgate.net/publication/331289190_Joint_specific_power_production_in_cycling_The_effect_of_cadence_and_intensity)). Hence they show the greatest de-saturation and look very similar between trials.
  * The **glutes tend to kick in more at higher torque and higher power outputs** ([Aasvold et al, 2019](https://www.researchgate.net/publication/331289190_Joint_specific_power_production_in_cycling_The_effect_of_cadence_and_intensity)). Here we can see some very interesting differences between the LAB & FIELD trials.
...
I mentioned the deltoid deoxygenation-breakpoint (deoxy-bp) in the [recent posts](https://sparecycles.blog/2019/12/04/comparing-vo2-master-to-trueone-part-2/#deltoid-breakpoint) comparing VMPro and TrueOne. Deltoid appears to de-saturate once the athlete begins to work above their Anaerobic Threshold (above steady-state). 

This is primarily due to increased metabolic demand for stabilization of the upper body during higher intensity efforts ([Ozyener, 2012](https://www.researchgate.net/publication/258035360_The_Contribution_of_Resting_Body_Muscles_to_the_Slow_Component_of_Pulmonary_Oxygen_Uptake_During_High-Intensity_Cycling)). But I’m curious whether we might also be seeing some redistribution of blood flow & O2 delivery away from the non-priority/non-locomotive muscles such as deltoid to preserve oxygenation at the brain, respiratory muscles, and priority working muscles? ([Bhambhani, 2012](https://www.researchgate.net/publication/258666287_Review_Application_of_near_infrared_pectroscopy_in_evaluating_cerebral_and_muscle_haemodynamics_during_exercise_and_sport))
...
Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/deltfield.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/deltfield.jpg) 
...
The glute signal in orange is really where things get interesting, and I can get back to some unbridled speculation! **Glute de-oxygenation appears deeper/lower saturation in the field** , as would be expected with greater recruitment and power contribution from the glutes ([Arkesteijn et al, 2013](https://www.researchgate.net/publication/233770194_The_Effect_of_Turbo_Trainer_Cycling_on_Pedalling_Technique_and_Cycling_Efficiency), [Aasvold et al, 2019](https://www.researchgate.net/publication/331289190_Joint_specific_power_production_in_cycling_The_effect_of_cadence_and_intensity)). Perhaps, say, because I had better core stabilization in the field which allowed my glutes to push harder on a more stable pelvis!

Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/glutefield.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/glutefield.jpg) 

However not just the SmO2 magnitude, but the _pattern_ of de-saturation is different between trials. In the LAB the glute shows a steady but slower downward slope during each work interval. In the FIELD trial the glute appears more similar to the VL: it de-saturates quickly and stabilizes at a minimum plateau. This suggests **greater oxygen extraction** (mVO2; local O2 uptake at the muscle) during the work intervals in the field. I would expect that EMG would have been higher at the glutes in the field, reflecting a greater hip-joint specific contribution to power output.
...
As far as indoor modalities go, the turbo trainer seems to facilitate a **‘brute force’ muscle recruitment of quads to generate most of the power**. Where maximizing workload is the desired adaptive stimulus, this might be sufficient ([Olsen, 2012](https://digitalcommons.usu.edu/cgi/viewcontent.cgi?article=1105&context=honors), [Tseh et al, 2017](https://www.researchgate.net/publication/318128455_Rollers_Versus_Trainers_10-Km_Time_Trial)). Such as during high intensity interval workouts. 
...
I think these factors are very likely involved in the common perception that power output is lower and relative effort is higher on the trainer. I have started to spend my [low intensity Aerobic rides](https://www.strava.com/activities/2947722620) focusing on a few cues to optimize these biomechanical patterns:
...
[ Illustration / Chart [https://sparecycles.blog/wp-content/uploads/2019/12/stravaactivity-1.jpg](https://sparecycles.blog/wp-content/uploads/2019/12/stravaactivity-1.jpg)  ](https://www.strava.com/activities/2947722620)
