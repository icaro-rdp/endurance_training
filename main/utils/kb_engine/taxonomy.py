...
class TaxonomyRegistry:
    ...
    CANONICAL_TOPICS: ClassVar[dict[str, TopicDefinition]] = {
        ...
        "Threshold_intervals": TopicDefinition(
            ...
            category="training",
            summary=(
                "Over-unders, 2x20m, threshold repeats, sustained FTP "
                "intervals, lactate clearance"
            ),
            synonyms=(
                "threshold intervals",
                "ftp intervals",
        ...
        "VO2max_and_aerobic_hiit": TopicDefinition(
            ...
            category="training",
            summary=(
                "Seiler 4x8/4x4, Ronnestad 30/15, fast-start HIIT, "
                "decreasing intervals, severe domain intervals"
            ),
            synonyms=(
                "vo2max intervals",
                "hiit",
        ...
        "Sprint_and_anaerobic_intervals": TopicDefinition(
            ...
            category="training",
            summary=(
                "Sprint Interval Training SIT 15-30s, repeated sprint "
                "ability RSA, microbursts"
            ),
            synonyms=(
                "sprint training",
                "sit",
        ...
        "Strength_and_resistance_training": TopicDefinition(
            ...
            category="training",
            summary=(
                "Gym heavy resistance training, squats, deadlifts, "
                "unilateral/bilateral, concurrent training"
            ),
            synonyms=(
                "strength training",
                "resistance training",
        ...
        "Torque_and_cadence_drills": TopicDefinition(
            ...
            category="training",
            summary=(
                "Low-cadence torque efforts, SFR, high-cadence spin-ups, "
                "neuromuscular pedaling drills"
            ),
            synonyms=(
                "heavy torque",
                "torque training",
        ...
        "Pacing_and_execution_dynamics": TopicDefinition(
            ...
            category="training",
            summary=(
                "Pacing tactics, ERG vs slope mode, RPE auto-regulation, "
                "TT/climb power distribution"
            ),
            synonyms=(
                "pacing",
                "pacing strategy",
        ...
        "Cross_training_and_multisport": TopicDefinition(
            ...
            category="training",
            summary=(
                "Modality transfer, run-to-bike transfer, swimming, "
        ...
        "Biomechanics_fit_and_equipment": TopicDefinition(
            ...
            category="training",
            summary=(
                "Bike fit ergonomics, saddle pressure, aerodynamics CdA, "
                "rolling resistance Crr, drivetrain friction"
            ),
            synonyms=(
                "bike fit",
                "biomechanics",
        ...
        "Cardiovascular_and_hemodynamics": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Stroke volume, eccentric left ventricular hypertrophy, "
                "cardiac output, preload, plasma volume"
            ),
            synonyms=(
                "cardiovascular",
                "stroke volume",
        ...
        "Mitochondrial_and_cellular_adaptation": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "PGC-1alpha, CaMK, AMPK vs mTOR signaling, citrate synthase, "
        ...
        "Lactate_kinetics_and_metabolism": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "MCT1/4 transporters, Brooks lactate shuttle, clearance "
                "dynamics, muscular/hepatic oxidation"
            ),
            synonyms=(
                "lactate shuttle",
                "lactate kinetics",
        ...
        "Substrate_utilization_and_fat_oxidation": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Beta-oxidation, CPT-1, FAT/CD36, IMTG vs FFA, glycogen "
                "depletion, FatMax, MFO, LCHF"
            ),
            synonyms=(
                "fat oxidation",
                "substrate oxidation",
        ...
        "Thresholds_and_metabolic_domains": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "3-domain model: moderate/heavy/severe, LT1/VT1, LT2/VT2, "
                "MLSS, RCP, OBLA"
            ),
            synonyms=(
                "lt1",
        ...
        "Critical_power_and_w_prime": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Hyperbolic power-duration model, Critical Power CP, W', "
                "W'bal, Skiba model, Critical Speed"
            ),
            synonyms=(
                "critical power",
                "cp",
        ...
        "FTP_and_functional_metrics": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Functional Threshold Power, Time-to-Exhaustion TTE at FTP, "
                "fractional utilization, MMP profile"
            ),
            synonyms=(
                "ftp",
        ...
        "VO2max_and_aerobic_kinetics": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "VO2max limits, phase I/II/III kinetics, time constant tau, "
                "VO2 slow component, MAP"
            ),
            synonyms=(
                "vo2max",
        ...
        "Durability_and_fatigue_mechanisms": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Durability over kJ, central/peripheral fatigue, motor unit "
                "recruitment, Henneman size principle"
            ),
            synonyms=(
                "durability",
                "fatigue resistance",
        ...
        "Autonomic_and_cardiac_monitoring": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Heart rate variability HRV, rMSSD, resting HR, "
                "cardiovascular drift, Power:HR decoupling"
            ),
            synonyms=(
                "hrv",
        ...
        "Environmental_and_thermal_stress": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Heat acclimation, core temperature kinetics, sweat rate, "
                "altitude/hypoxia, EPO, cold stress"
            ),
            synonyms=(
                "heat stress",
                "temperature effects",
        ...
        "Physiological_testing_and_diagnostics": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Metabolic cart, FatMax testing, lactate step tests, ramp "
                "tests, 20-min test, NIRS/SmO2"
            ),
            synonyms=(
        ...
        "Athlete_health_and_exercise_immunology": TopicDefinition(
            ...
            category="physiology",
            summary=(
                "Exercise immunology, J-curve, sickness return-to-play, "
                "AFib, bone health, female menstrual cycle"
            ),
            synonyms=(
                "exercise immunology",
                "illness",
        ...
        "Carbohydrate_fueling_and_gut_training": TopicDefinition(
            ...
            category="nutrition",
            summary=(
                "Intra-workout carb rates 30-120g/hr, glucose:fructose "
                "1:0.8/2:1, SGLT1/GLUT5, gut training"
            ),
            synonyms=(
        ...
        "Daily_macronutrient_and_energy_periodization": TopicDefinition(
            ...
            category="nutrition",
            summary=(
                "Carbohydrate periodization, fuel for work, "
                "train-low/sleep-low, protein 1.6-2.2g/kg, MPS"
            ),
            synonyms=(
        ...
        "Hydration_and_electrolyte_balance": TopicDefinition(
            ...
            category="nutrition",
            summary=(
                "Fluid replacement, sweat rate calculation, sweat sodium "
        ...
        "Energy_availability_and_reds": TopicDefinition(
            ...
            category="nutrition",
            summary=(
                "Relative Energy Deficiency in Sport RED-S, Low Energy "
                "Availability LEA <30 kcal/kg, endocrine health"
            ),
            synonyms=(
                "red-s",
                "reds",
        ...
        "Ergogenic_supplements_and_buffers": TopicDefinition(
            ...
            category="nutrition",
            summary=(
                "Sodium bicarbonate, beta-alanine, caffeine, dietary "
                "nitrates/beetroot, creatine, ketone esters"
            ),
            synonyms=(
                "ergogenic aids",
                "ergogenic_aids",
        ...
        "Micronutrients_and_biomarkers": TopicDefinition(
            ...
            category="nutrition",
            summary=(
                "Iron metabolism, serum ferritin, hepcidin, Vitamin D3, "
                "antioxidant debate: Vitamin C/E, blood panels"
            ),
            synonyms=(
                "micronutrients",
                "antioxidants",
        ...
        "Periodization_models_and_macrocycles": TopicDefinition(
            ...
            category="planning",
            summary=(
                "Linear, block periodization, reverse, phase potentiation, "
                "annual plan ATP, progressive overload"
            ),
            synonyms=(
                "periodization",
                "block_periodization",
        ...
        "Training_intensity_distribution": TopicDefinition(
            ...
            category="planning",
            summary=(
                "TID: Polarized 80/20, pyramidal, threshold-centric "
                "distribution, session-goal vs time-in-zone"
            ),
            synonyms=(
        ...
        "Microcycle_and_schedule_design": TopicDefinition(
            ...
            category="planning",
            summary=(
                "7-day/10-day microcycles, session sequencing, Norwegian "
                "double threshold scheduling, recovery weeks"
            ),
            synonyms=(
                "microcycles",
                "double_threshold",
        ...
        "Workload_quantification_and_modeling": TopicDefinition(
            ...
            category="planning",
            summary=(
                "PMC: CTL/ATL/TSB, TSS, NP, IF, Banister impulse-response "
                "model, TRIMP, mechanical kJ"
            ),
            synonyms=(
        ...
        "Tapering_and_peaking": TopicDefinition(
            ...
            category="planning",
            summary=(
                "Exponential volume reduction 40-60%, intensity/frequency "
                "maintenance, taper duration, race openers"
            ),
            synonyms=(
                "tapering",
                "taper",
        ...
        "Overtraining_and_recovery_management": TopicDefinition(
            ...
            category="planning",
            summary=(
                "Functional/non-functional overreaching, OTS, sleep "
                "architecture, recovery modalities"
            ),
            synonyms=(
                "overtraining",
        ...
        "Psychology_and_cognitive_performance": TopicDefinition(
            ...
            category="planning",
            summary=(
                "Psychobiological model of endurance, RPE governor, mental "
                "fatigue, ACT training, resilience"
            ),
            synonyms=(
                "sports psychology",
                "psychology",
    ...
    def __init__(self, kb_dir: Path | None = None):
        ...
        self._topics_by_category: dict[str, list[str]] = {
            cat: [
                defn.slug
                for defn in self.CANONICAL_TOPICS.values()
    ...
    def _load_from_directory(self, kb_dir: Path) -> None:
        """Optionally load custom taxonomy if TAXONOMY.md exists."""
    ...
    def generate_taxonomy_markdown(cls, kb_dir: Path | None = None) -> str:
        """Generate canonical TAXONOMY.md Markdown from Python definitions."""
        lines = [
            "# Endurance Training Knowledge Base Taxonomy",
            "",
            "This file is the canonical source for Knowledge Base categories,",
            "topics, and source frontmatter. New Knowledge Sources must use only",
            "the exact category and topic values listed here.",
            "",
            "---",
            "",
        ...
        descriptions = {
            ...
            "physiology": (
                "Underlying biological mechanisms, cardiovascular remodeling, "
                "cellular bioenergetics, metabolic thresholds, fatigue etiology, "
                "and diagnostic assessment."
            ),
            "nutrition": (
                "Nutritional fueling, intra-workout carbohydrates, hydration/fluid "
                "balance, clinical energy availability, micronutrients, and "
                "ergogenic supplementation."
            ),
            "planning": (
                "Periodization models, training intensity distributions, "
                "microcycle architecture, workload quantification, tapering, and "
        ...
        lines.extend(
            [
                ...
                "",
                "Every curated Markdown Knowledge Source must begin with a YAML",
                "mapping. The current validator reports a blocking workflow error",
                "when any of these minimum fields is missing or empty:",
                "",
                "- `title`",
                "- `category`",
                "- `topics`",
                "- `summary`",
                "",
                "Every Knowledge Source must use the standard provenance contract:",
                "",
                "```yaml",
                "---",
                ...
                "- `category` is exactly one of `training`, `physiology`, `nutrition`,",
                "  or `planning`.",
                "- Every topic uses the exact spelling and case from this file.",
                "  Do not introduce a near-synonym as a one-off tag.",
                "- `source`, `author`, and `date` record real provenance.",
                "  A publication date uses `YYYY-MM-DD`; do not invent placeholders.",
                "- `key_takeaways` is optional. Omit it when no takeaways have been",
                "  deliberately curated; indexing does not synthesize it.",
                "",
                "The passage layer derives `source_type`, repository-relative path,",
                "`source_slug`, passage identifiers and boundaries, citation line",
                "ranges, and size diagnostics. Those values do not belong in",
                "source frontmatter.",
                "",
            ]
        )
        ...
        if kb_dir:
            ...
            if (
                not tax_file.exists()
                or tax_file.read_text(encoding="utf-8") != markdown_content
            ):
